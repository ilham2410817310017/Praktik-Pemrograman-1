...
int main() {
    ...
    double diskon_A = 0.13;  // 13%
    double diskon_B = 0.21;  // 21%

    printf("Harga sepatu A adalah %d\n", harga_sepatu_A);
    printf("Harga sepatu B adalah %d\n", harga_sepatu_B);

    double harga_setelah_diskon_A = harga_sepatu_A * (1 - diskon_A);
    double harga_setelah_diskon_B = harga_sepatu_B * (1 - diskon_B);
